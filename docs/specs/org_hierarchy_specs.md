...
| ------------------------ | --------------------------------------------------------- | --------------------------------------------------------------- |
| Role Assignment          | See [ac_specs.md §3.5](./ac_specs.md#35-role-assignments) | Extends with `org_id` for multi-org                             |
| Node Paths               | Unique per organization                                   | Unique per organization; `org_id` required in queries           |
| Authorization Resolution | `Applicable(U, R, P, A, I)`                               | `Applicable(U, R, P, A, I, org_id)`                             |
